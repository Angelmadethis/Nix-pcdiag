...
/// <summary>
/// Implements the <c>pcdiag check tcp</c> command: runs the TCP configuration and
/// statistics check and prints its detailed report. Read-only; no interaction required.
/// </summary>
public static class TcpCommand
{
    public static async Task<int> RunAsync(CancellationToken cancellationToken = default)
    {
        ...
        {
            Console.Error.WriteLine($"pcdiag check tcp failed: {ex.Message}");
            return 1;
        }
    }
}